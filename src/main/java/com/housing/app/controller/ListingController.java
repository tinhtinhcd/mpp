...
public class ListingController {
    ...
    @GetMapping(value = "/latestListing")
    public ResponseEntity latestListing(@RequestParam(name = "limit") int limit) {
        return new ResponseEntity(mapper.toListingDtos(listingService.findLatestListing(limit)), HttpStatus.OK);
    }
    ...
    @GetMapping(value = "/{id}")
    public ResponseEntity<ListingDto> viewDetail(@PathVariable Long id) {
    ...
    public ResponseEntity deleteListing(@PathVariable Long id) {
        ...
        result.put("status", "Delete Listing Successfully");
